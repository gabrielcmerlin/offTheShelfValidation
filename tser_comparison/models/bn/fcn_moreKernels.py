...
class FCN_moreKernels(nn.Module):
    ...
    def __init__(self, input_channels):
        ...
        self.layers = nn.ModuleList([
            ...
            nn.Conv1d(in_channels=input_channels, out_channels=256, kernel_size=8, padding='same'),
            nn.BatchNorm1d(256),
            nn.ReLU(),
...
class FCNClassifier_mk(FCN_moreKernels):
    
    def __init__(self, input_channels, num_classes):
        super().__init__(input_channels)
        self.final_layer = nn.Linear(in_features=256, out_features=num_classes)
...
class FCNRegressor_mk(FCN_moreKernels):
